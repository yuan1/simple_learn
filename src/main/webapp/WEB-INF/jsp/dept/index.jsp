...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 系统管理 <span
        class="c-gray en">&gt;</span> 组织机构 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px"
...
<div style="height: 90%">
        ...
        <div class=" col-xs-12 col-sm-10">
            <IFRAME id="deptIframe" name="deptIframe" FRAMEBORDER=0 SCROLLING=AUTO width=100% height=100%
                    src="dept/info"></IFRAME>
        </div>
</div>
...
<script type="text/javascript">
    ...
    function onClick(event, treeId, treeNode, clickFlag) {
        loadIframe('deptIframe', 'dept/show/' + treeNode.id)
    }
