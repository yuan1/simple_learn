        ...
        <div class="content">
            <div class="page-login">
                    ...
                    <ul>
                        ...
                        <li>
                            <div class="item-content">
                                ...
                                <div class="item-inner">
                                    <div class="item-input">
                                        <input type="text" placeholder="用户名" id="regUname">
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="item-content">
                                ...
                                <div class="item-inner">
                                    <div class="item-input">
                                        <input type="text" placeholder="昵称" id="regUnick">
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="item-content">
                                ...
                                <div class="item-inner">
                                    <div class="item-input">
                                        <input type="password" placeholder="密码" id="regPWD">
                                    </div>
                                </div>
                            </div>
                        </li>
                ...
                <div class="content-block">
                    <p><a class="button button-big button-fill" href='javascript:' id="regist-2" data-transition='fade'>完成</a></p>
                </div>
            </div>
        </div>
    </div>
