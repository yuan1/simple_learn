...
<div class="page-container">
        <form action="learn/news/add/do" method="post" class="form form-horizontal" id="form-add">
            <div class="row cl">
                <label class="form-label col-xs-3 col-sm-2">标题：</label>
                <div class="formControls col-xs-9 col-sm-10">
                    <input class="input-text" autocomplete="off" placeholder="标题" type="text" name="title" id="title" required>
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-3 col-sm-2">简介：</label>
                <div class="formControls col-xs-9 col-sm-10">
                    <input class="input-text" autocomplete="off" placeholder="简介" type="text" name="brief" id="brief" required>
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-3 col-sm-2">作者昵称：</label>
                <div class="formControls col-xs-9 col-sm-10">
                    <input class="input-text" autocomplete="off" placeholder="作者昵称" type="text" name="author" id="author" required>
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-9 col-sm-10">
                    <span class="btn-upload form-group">
							...
							<input name="breviary" class="input-file" type="hidden" id="imageInput" value="FibK0e5Nbnz_9KcUSbnVAXLP2y50">
                    </span>
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-9 col-sm-10">
							<img src="http://images.javayuan.cn/FibK0e5Nbnz_9KcUSbnVAXLP2y50" id="imageNow" width="240px" height="160px" alt="..." class="radius">
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-2 col-sm-3">
                    <input class="input-text" autocomplete="off" placeholder="赞数量" type="number" name="laud" id="laud" required>
                </div>
            </div>
            <div class="row cl">
